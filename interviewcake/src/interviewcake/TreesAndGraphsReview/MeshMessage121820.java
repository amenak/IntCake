...
public class MeshMessage121820 {
	...
	public String [] constructPath(String startNode, String endNode, HashMap<String,String> nodesMap) {
    ...
    public static String[] getPath(Map<String, String[]> graph, String startNode, String endNode) {
        ...
        List<String> path = new ArrayList<String>();
        path.add(endNode);
        String current = nodeMap.get(endNode);
        ...
        if(path.size() == 1) { //i have to do this because there code calls construct path. which is admittedly more cleaner. 
        	return null;
        }
