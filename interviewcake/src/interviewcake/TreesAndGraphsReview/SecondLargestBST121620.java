...
public class SecondLargestBST121620 {
    ...
    public static int findSecondLargest(BinaryTreeNode rootNode) {
    	if(rootNode == null || rootNode.left==null && rootNode.right==null) {
    		throw new IllegalArgumentException("Tree must have atleast two nodes to find second largest.");
    	}

    	//loop until you reach largest node
    	//case1: right child has no children return node
    	//case2: right child has left subtree return largest
    ...
    public static int findLargest(BinaryTreeNode node) {
    	if(node.right == null) { //if theres no more right node, it will return the value of the right most node. 
    		return node.value;
    	}
    	return findLargest(node.right); //will traverse all the way to the right. 
    }

    //iterative
    public static int findLargest1(BinaryTreeNode node) {
    ...
    public static void main(String[] args) {
        Result result = JUnitCore.runClasses(SecondLargestBST121620.class);
