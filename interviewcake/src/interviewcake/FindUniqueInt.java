...
public class FindUniqueInt {
    ...
    public static int findUniqueDeliveryId(int[] deliveryIds) {
    	if(deliveryIds.length == 0) throw new IllegalArgumentException("deliveryIds can not be empty");
    		
        // find the one unique ID in the array
        //XOR all IDS, duplicates will cancel each other out.
...
//O(1) space
    ...
    public static void main(String[] args) {
        Result result = JUnitCore.runClasses(FindUniqueInt.class);
